        ...
        setContent {
            ...
            LectorPDFTheme(settings.theme, settings.dynamicColor) {
                ...
                PdfReaderScreen(
                    ...
                    brightnessGestureEnabled = settings.pdfBrightnessGesture,
                    themeCornerGestureEnabled = settings.pdfThemeCornerGesture,
                    bookmarkCornerGestureEnabled = settings.pdfBookmarkCornerGesture,
                    showBookmarkInFocus = settings.pdfShowBookmarkInFocus,
                    ...
                    onSetBrightnessGesture = { value -> lifecycleScope.launch { (application as LectorApplication).container.settingsRepository.setPdfBrightnessGesture(value) } },
                    onSetThemeCornerGesture = { value -> lifecycleScope.launch { (application as LectorApplication).container.settingsRepository.setPdfThemeCornerGesture(value) } },
                    onSetBookmarkCornerGesture = { value -> lifecycleScope.launch { (application as LectorApplication).container.settingsRepository.setPdfBookmarkCornerGesture(value) } },
                    onSetShowBookmarkInFocus = { value -> lifecycleScope.launch { (application as LectorApplication).container.settingsRepository.setPdfShowBookmarkInFocus(value) } },
                    onBack = ::exitReader,
